...
public class LeyouChargingFormBean {
	...
	@DataValidate(description = "sdk登录帐号", nullable = false)
	...
	public void setAttach(String attach) {
		this.attach = Common.urlDecode(attach,"UTF-8");
	}
	public String getSign() {
		return sign;
	}
	public void setSign(String sign) {
		this.sign = Common.urlDecode(sign,"UTF-8").replace(" ", "+").replace("\\", "");
	}
	@Override
