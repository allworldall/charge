...
public class PywChargingFormBean {
	...
	public PywChargingFormBean(String gameName,String cpName,PywReqBean bean){
		...
		this.cp_orderid = bean.getCh_orderid();
		this.ch_orderid = bean.getCh_orderid();
		this.amount = bean.getAmount();
		this.cp_param = bean.getCp_orderid();
	}
