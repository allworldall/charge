 ...
 * 今日头条FormBean
 * */
public class JRTTChargingFormBean {
	...
	@DataValidate(description = "通知类型，支付异步通知：trade_status_sync", nullable = false)
    private String  notify_type;
	@DataValidate(description = "通知时间，格式为【yyyy-MM-dd HH:mm:ss】", nullable = false)
	...
	@DataValidate(description = "商品订单号，对应合作方订单号", nullable = false)
    private String  out_trade_no;
	@DataValidate(description = "支付流水号", nullable = true)
    //	支付宝对：trade_no 微信对应：transaction_id
	private String  trade_no;
	@DataValidate(description = "支付时间，格式为【yyyy-MM-dd HH:mm:ss】", nullable = true)
    private String  pay_time;
	@DataValidate(description = "总费用，单位为分", nullable = true)
    private Integer total_fee;
	@DataValidate(description = "购买者", nullable = false)
	//支付宝对应buyer_email 微信对应open_id
    private String  buyer_id;
	@DataValidate(description = "头条签名", nullable = false)
	private String  tt_sign;
	@DataValidate(description = "头条签名类型暂只支持RSA签名", nullable = false)
